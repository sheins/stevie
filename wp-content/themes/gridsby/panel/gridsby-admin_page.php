<?php 
    ...
    function gridsby_setup_menu(){
 	...
 	function gridsby_init(){ 
		...
		printf( __('1.2.3 - Update: blog will go fullwidth if no sidebar is active', 'gridsby' )); 
		echo '</p>';
		
		echo '<p style="text-align: center;">'; 
		printf( __('1.2.2 - Update: added many new social icon options to theme customizer', 'gridsby' )); 
		echo '</p>';
		
		echo '<p style="text-align: center;">'; 
		printf( __('1.2.0 - Update: added new social icon links', 'gridsby' )); 
		echo '</p>';
		
		echo '<p style="text-align: center;">'; 
		printf( __('1.1.10 - Fix: minor bug fixes and improvements', 'gridsby' )); 
		echo '</p>'; 
		
		echo '<p style="text-align: center;">'; 
		printf( __('1.1.8 - Update: updated demo link in description', 'gridsby' )); 
		echo '</p>'; 
