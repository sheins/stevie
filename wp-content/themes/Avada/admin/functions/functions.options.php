...
// Set the Options Array
        ...
        $of_options[] = array( "name" => "Mega Menu Column Title Size",
            "desc" => "Set the font size for mega menu column titles (menu 2nd level labels). In pixels, ex: 24px",
        ...
        $of_options[] = array( "name" =>  "Button Gradient Top Hover Color",
            "desc" => "Controls the top hover color of the button gradients.",
            "id" => "button_gradient_top_color_hover",
            "std" => "#AAD75B",
            "type" => "color");

        $of_options[] = array( "name" =>  "Button Gradient Bottom Hover Color",
            "desc" => "Controls the bottom hover color of the button gradients.",
        ...
        $of_options[] = array( "name" => "Button Border Width",
            "desc" => "Select the border wodth for buttons. Enter value in px. ex: 1px",
...
// Theme Specific Options
        ...
        $of_options[] = array( "name" => "Basis for Excerpt Length",
            ...
            "id" => "excerpt_base",
            "std" => "words",
            "options" => array('words' => 'Words', 'chars' => 'Characters'),
            "type" => "select");
