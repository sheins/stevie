		...
		<ul class="slides">
			<?php
				...
				if ( has_post_thumbnail() ) {
					...
					// Avada Edit
					echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<li><a href="%s" itemprop="image" class="woocommerce-main-image" title="%s">%s</a></li>', $image_link, $image_title, $image ), $post->ID );
